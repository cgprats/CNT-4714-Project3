# The root user execution script for Project Three - CNT 4714 - Fall 2020
# all commands assumed to be executed by the root user
#
#Command 1:
#   Query: Which rider won Fleche Wallone - Feminine in 2014?
select ridername
from racewinners
where racename = 'Fleche Wallone - Feminine' and raceyear = 2014;
...
#Command 7:
#   Delete all the riders from Luxembourg from the riders table.
#   * * * Do a "before" and "after" select * from riders for this command.
select * from riders;
delete from riders where nationality = 'Luxembourg';
select * from riders;
